	...
	<body class="loggedin">
		<nav class="navtop">
			<div>
				...
				<a href="home.php"><i class="fas fa-asterisk"></i>Dosya Yükle</a>
...
if(isset($_POST['deer'])){
$result = mysqli_query($con,"SELECT * FROM dosyalar WHERE dosyayukleyen='$yukleyen' AND dosyaders ='$derss' ");
...
$result = mysqli_query($con,"SELECT * FROM dosyalar WHERE dosyayukleyen='$yukleyen' AND dosyabaslik = '$projj'");
...
$result = mysqli_query($con,"SELECT * FROM dosyalar WHERE dosyayukleyen='$yukleyen' AND dosyadonem ='$donemm'");
...
$result = mysqli_query($con,"SELECT * FROM dosyalar WHERE dosyayukleyen='$yukleyen' AND  dosyayazar ='$yazarr'");
