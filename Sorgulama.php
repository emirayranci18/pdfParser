	...
	<body class="loggedin">
		...
		<div class="login">
			...
			<form method="post">
				...
				<input type="text" name="kullanici" placeholder="Yükleyen Kullanıcıyı Giriniz" id="kullanici" required>
				<label for="userid">
					<i class="fa fa-bars"></i>
				</label>
...
$result = mysqli_query($con,"SELECT * FROM dosyalar");
...
if(isset($_POST['deer'])){
$result = mysqli_query($con,"SELECT * FROM dosyalar WHERE dosyaders ='$derss' AND dosyayukleyen ='$kullanicii' AND dosyadonem ='$donemm'");
